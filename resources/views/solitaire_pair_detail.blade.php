            ...
            <div class="col-lg-6">
                ...
                <div>
                    <div class="slider-content" id="slider-section-1">
                        <div class="xzoom-container h-100">
                            <a data-fancybox-trigger="gallery" href="javascript:;">
                                <img class="xzoom h-100 w-100 image-1" id="xzoom-default" src="{{$solitaire[0]['ImageLink']}}" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"/>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="slider-thumb">
                        <div class="slide"><img src="{{$solitaire[0]['ImageLink']}}" alt="" class="img-fluid thumb-image thumb-image-1" data-id="1" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"></div>
            ...
            <div class="col-lg-6">
                ...
                <div>
                    <div class="slider-content" id="slider-section-2">
                        <div class="xzoom-container h-100">
                            <a data-fancybox-trigger="gallery" href="javascript:;">
                                <img class="xzoom h-100 w-100 image-1" id="xzoom-default" src="{{$solitaire[1]['ImageLink']}}" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"/>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="slider-thumb">
                        <div class="slide"><img src="{{$solitaire[1]['ImageLink']}}" alt="" class="img-fluid thumb-image thumb-image-1" data-id="2" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"></div>
...
<script>
    ...
    $(document).on('click', '#select-diamond', async function() {
        ...
        let custProdParam = [{
                ...
                product_type: 'solitaire_pair' //  solitaire, product, loose_solitaire, loose_pair
            },
            {
        ...
        try {
            ...
            if (res.flag === 1) {
                let selected_solitaire_pair_data = await res.data;
                selected_solitaire_data = await res.data;
                localStorage.setItem('selected_solitaire', JSON.stringify(selected_solitaire_pair_data));
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        window.location.href = base_url + '/design-your-own-solitaire-earrings?cat=' + product + '&selected=1';
                    }
                });
    ...
    async function getProductPairPrice(prodParam) {
        console.log('cust param : ', prodParam);
