                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3">
                            <div class="item-image-block text-center">
                                <img src="{{url('public/assets/img/product/').'/'.$orderDetail['product_sku'].'/'.$orderDetail['product_sku'].'_'.config('constant.COLOR_CODE.'.$orderDetail['product_color']).'1.jpg'}}" class="img-thumbnail">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-9 col-lg-9">
                            <div class="item-title-block">
                                ...
                                <div class="item-attribute-block">
                                    <table class="table table-hover item-attr-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$orderDetail['product_gold_quality']}}Ct {{$orderDetail['product_color']}} gold, {{$orderDetail['product_gold_weight']}} gm</td>
                                        </tr>
                                ...
                                <div class="item-button-block">
                                    <button type="button" class="btn"><i class="fa-solid fa-truck-fast"></i> Order Received </span></button>
                                    ...
                                    <button type="button" class="btn" onclick="cancelOrder(`{{$order['order_id']}}`,`{{$orderDetail['id']}}`)"><i class="fa-solid fa-xmark"></i> Cancel Item</button>
                                    @endif
                                    @endif
                                </div>
                            </div>
                ...
                <div class="cart-summart-block-main">
                    ...
                    <div class="item-order-summary shadow p-3">
                        ...
                        <div class="item-summary-block">
                            ...
                            <span class="text-success">{{config('constant.ORDER_STATUS.'.$order['order_status'])}}</span>
                        </div>
                        ...
                        <div class="bill-detail">
                            ...
                            <p class="mb-2"><i class="fa fa-phone" aria-hidden="true"></i> {{$order['billing_address']['mobile_no']}}</p>
                        ...
                        <div class="ship-detail">
                            ...
                            <p class="mb-2"><i class="fa fa-phone" aria-hidden="true"></i> {{$order['shipping_address']['mobile_no']}}</p>
                    ...
                    <div class="item-contact-block">
                        <p>Any Questions?</p>
                        <p>Please call us at <b><a href="tel:+91 9799975281">+91 9799975281</a></b> or Chat with us <a href="https://api.whatsapp.com/send?phone=919799975281&amp;text=Hi! Need information on the product | https://diamondsutra.in" class="fs-4 text-success p-1"><i class="fa-brands fa-whatsapp"></i></a></p>
                    </div>
