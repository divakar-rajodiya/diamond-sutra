    ...
    <div class="row gy-3 gy-md-4">
      <div class="col-lg-6">
        ...
        <div>
          <div class="slider-content">
            <div class="xzoom-container h-100">
              <a data-fancybox-trigger="gallery" href="javascript:;">
                @php $defaultImage = 'http://dev.diamondsutra.in/public/assets/img/solitaire/'.$solitaire['DisplayShape'].'.jpg'; @endphp
                <img class="xzoom h-100 w-100 image-1" id="xzoom-default" src="{{$solitaire['ImageLink']}}" onerror="this.onerror=null; this.src='<?php echo $defaultImage; ?>'"/>
              </a>
            </div>
          </div>
          ...
          <div class="canva-section w-100 h-100 d-flex justify-content-center d-none">
            <iframe width="600" height="600" src="{{$solitaire['CanvaLink']}}" frameborder="0"></iframe>
          </div>
          <div class="slider-thumb">
            <div class="slide"><img src="{{$solitaire['ImageLink']}}" alt="" class="img-fluid thumb-image thumb-image-1" onerror="this.onerror=null; this.src='<?php echo $defaultImage; ?>';"></div>
            ...
            @endif
            @if($solitaire['CanvaLink'] != '')
            <div class="slide"><img src="{{url('public/assets/img/video-thumb.png')}}" alt="" class="img-fluid canva-thumb-image"></div>
            @endif
      ...
      <div class="col-lg-6">
        <div class="product-info-panel">
          ...
          <div class="product-info-price mb-3">
            <span class="subtotal-price">{{\General::currency_format($solitaire['product_buy_price'])}}</span>
          </div>
          ...
          <div class="cart-btn-group my-4">
            <button class="btn primary-btn large-btn w-100 mb-2 mb-sm-3" id="select-diamond">Buy Now</button>
          ...
          <!-- <div class="shipping-detail">
            <div class="d-flex mb-2 align-items-center justify-content-between gap-2">
              ...
              <div class="d-flex align-items-center gap-2">
                <a href="tel:+919799975281" class="btn fs-4 text-success p-1"><i class="fa-solid fa-phone"></i></a>
...
<script>
  $(document).ready(function() {
    ...
    $(document).on('click', '.canva-thumb-image', function() {
      $('.slider-content').addClass('d-none');
      $('.canva-section').removeClass('d-none');
    });
    ...
    // Set additional properties on the diamond object
    diamond.product_type = 'loose_solitaire';
    diamond.item_type = 'primary';

    $(document).on('click', '#select-diamond', async function() {
      let custProdParam = {
        ref_no: diamond.RefNo,
        cert_no: diamond.CertNo,
        product_type: 'loose_solitaire' //  solitaire, product, loose_solitaire, loose_pair
      };
      ...
      try {
        ...
        if (res.flag === 1) {
          ...
          productDetails.sort_index = sort_index;
          if (!cart[productDetails.RefNo]) {
            cart[productDetails.RefNo] = productDetails;
