          ...
          <div class="slider-content">
            <div class="xzoom-container h-100">
              <a data-fancybox-trigger="gallery" href="javascript:;">
                <img class="xzoom h-100 w-100 image-1" id="xzoom-default" src="{{$solitaire['ImageLink']}}" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"/>
              </a>
            </div>
          </div>
...
<script>
  ...
  $(document).on('click', '#select-diamond', async function() {
    ...
    let custProdParam = {
      ...
      product_type: 'solitaire' //  solitaire, product, loose_solitaire, loose_pair
    };
    ...
    try {
      ...
      if (res.flag === 1) {
        ...
        localStorage.setItem('selected_solitaire', JSON.stringify(selected_solitaire_data));
        ...
        $.ajax({
          ...
          success: function(res) {
            if (res.flag == 1) {
              window.location.href = base_url + '/design-your-own-solitaire-'+product+'?cat=' + product + '&selected=1';
            }
          }
        });
      }
