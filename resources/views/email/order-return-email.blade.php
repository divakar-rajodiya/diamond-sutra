                                ...
                                <table style="text-align: center; padding: 0 15px;">
                                    <tr>
                                        <td style="color: #000;font-size: 28px;line-height: 32px;font-weight: bold; padding: 20px 0;">
                                            We regret that you have initiated return for the order <a href="{{ url('/user/order-detail').'/'.$orderDetail['order_with_detail']['order_id'] }}" target="_blank">{{$orderDetail['order_with_detail']['order_id']}}</a>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table style="width: 100%;border-spacing: 0;text-align:center;">
                                                <tr style="text-align: center;">
                                                    <td style="text-align: center; padding: 40px 0;" colspan="4">
                                                        <a href="{{ url('/user/order-detail').'/'.$orderDetail['order_with_detail']['order_id'] }}" style="text-decoration: none; font-size: 16px;color: #fff; padding: 12px 20px; border-radius: 30px; background-color: #000;display:inline-block;">View your order</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
