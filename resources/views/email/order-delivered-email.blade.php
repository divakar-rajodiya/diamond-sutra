...
<head>
    ...
    <title>Diamond Sutra Order Delivered</title>
</head>
                    ...
                    <table style="border-spacing: 0;">
                                ...
                                <table style="text-align: center; padding: 0 15px;">
                                    <tr>
                                        <td style="color: #000;font-size: 28px;line-height: 32px;font-weight: bold; padding: 20px 0;">
                                            We're thrilled to inform you that your order {{ $orderDetail['order_with_detail']['order_id'] }} has been successfully delivered!
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table style="width: 100%;border-spacing: 0;">
                                                <tr>
                                                    <td style="text-align: center;" colspan="4">
                                                        <img width="100%" src="{{ asset('public/assets/img/arrow-timeline-4.png')}}" alt="Diamond Sutra promises">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td valign="top" style="width: 25%; text-align: center; padding: 0;margin: 0; font-size: 12px; font-weight: 600; padding: 10px 0 0;">
                                                        <span style="font-weight: 600;">Delivered</span>
                                    ...
                                    <tr>
                                        <td style="color: #000;font-size: 16px;line-height: 22px;font-weight: normal;">
                                            We hope you love your new jewellery pieces. If you have any questions or concerns, please don't hesitate to get in touch.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: #000;font-size: 16px;line-height: 22px;font-weight: normal;">
                                            Thank you for choosing Diamond Sutra. We appreciate your support and hope to serve you again soon.
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td style="text-align: left;padding-bottom:10px;">
                                <p>Regards</p>
                                <p> Diamond Sutra</p>
                                <p>9799975281, Mon-Fri, 9am-9pm</p>
                            </td>
                        </tr>
                        <tr>
