...
<head>
    ...
    <title>Diamond Sutra Order Confirmation</title>
</head>
...
<body>
    ...
    <body link="#00a5b5" vlink="#00a5b5" alink="#00a5b5">
        ...
        <table class=" main contenttable" style="font-family: Arial, sans-serif;font-weight: normal;border-collapse: collapse;border: 0;margin-left: auto;margin-right: auto;padding: 0;color: #000;background-color: white;font-size: 16px;line-height: 26px;width: 700px;">
            <tr>
                <td class="border" style="margin: 0;padding: 0; background: #fff; box-shadow: 1px 6px 9px 0px #ccc;">
                    <table style="border-spacing: 0;">
                                            ...
                                            <table style="width: 100%;border-spacing: 0;">
                                                <tr>
                                                    <td style="text-align: center;" colspan="4">
                                                        <img width="100%" src="{{ asset('public/assets/img/arrow-timeline.png')}}" alt="Diamond Sutra promises">
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="text-align: center; padding: 40px 0;" colspan="4">
                                                        <a href="{{ url('/order-detail').'/'.$orderDetail['order_id'] }}"
                                                            style="text-decoration: none; font-size: 16px;color: #fff; padding: 12px 20px; border-radius: 30px; background-color: #000;">view
                                                            your order</a>
                                                    </td>
                                                </tr>
                                            </table>
                        ...
                        <tr>
                            <td colspan="2">
                                <p style="font-size: 18px; font-weight: bold;color: #000;margin: 15px 0px 0px 0px;">Items Details</p>
                            </td>
                        </tr>
                                ...
                                <table style="width: 100%; vertical-align: top;">
                                    <tr>
                                        ...
                                        <td style="padding: 0 10px;">
                                            ...
                                            $diamond = $diamond[0];
                                            @endphp
                                            <p style="font-size: 16px; line-height: 18px;color: #000; margin: 0 0 4px;">Diamond : {{$diamond['quantity']}} {{$diamond['shape']}} Diamond, {{$diamond['carat']}} Carat, {{config('constant.'.$item['product_diamond_quality'])}}</p>
                                            @endif
                                    ...
                                    <tr>
                                        <td style="padding: 10px; width: 50%; vertical-align: top;">
                                            <p
                                                ...
                                                Shipping Address</p>
                                            <p style="margin: 0;">{{$orderDetail['shipping_address']['address']}}, {{$orderDetail['shipping_address']['landmark']}} <br> {{$orderDetail['shipping_address']['city']}}, {{$orderDetail['shipping_address']['state']}}, {{$orderDetail['shipping_address']['country']}}, {{$orderDetail['shipping_address']['pincode']}}
                                            </p>
                                        </td>
                                        <td style="padding: 10px 0px 10px 0px; width: 52%; vertical-align: top;">
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td style="border-top: 1px solid #ccc; padding: 10px 0;">Item Total</td>
                                                    <td style="border-top: 1px solid #ccc; padding: 10px 0;">{{\General::currency_format($orderDetail['item_total'] - $orderDetail['gst_total'])}}</td>
                                                </tr>
                                                <tr>
                                                    <td>GST</td>
                                                    <td>{{\General::currency_format($orderDetail['gst_total'])}}</td>
                                                </tr>
                                                @if($orderDetail['discount_total'] > 0)
                                                <tr>
                                                    <td style="border-top: 1px solid #ccc; padding: 10px 0;">Coupon Discount</td>
                                                    <td style="border-top: 1px solid #ccc; padding: 10px 0;">{{\General::currency_format($orderDetail['discount_total'])}}</td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    <td>USPD Priority Mail</td>
                                                </tr>
                                                <tr>
                                                    <td style="border-top: 1px solid #ccc; padding: 10px 0;">Order Total</td>
                                                    <td style="border-top: 1px solid #ccc; padding: 10px 0;">{{\General::currency_format($orderDetail['order_total'])}}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
