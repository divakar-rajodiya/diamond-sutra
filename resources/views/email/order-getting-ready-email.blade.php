...
<head>
    ...
    <title>Diamond Sutra Order Getting Ready</title>
</head>
                                ...
                                <table style="text-align: center; padding: 0 15px;">
                                    <tr>
                                        <td style="color: #000;font-size: 28px;line-height: 32px;font-weight: bold; padding: 20px 0;">
                                            Woohoo! Your order is getting ready.
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table style="width: 100%;border-spacing: 0;">
                                                <tr>
                                                    <td style="text-align: center;" colspan="4">
                                                        <img width="100%" src="{{ asset('public/assets/img/arrow-timeline-2.png')}}" alt="Diamond Sutra promises">
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table style="width: 100%; vertical-align: top;">
                                                <tr>
                                                    ...
                                                    <td style="padding: 0 10px;">
                                                        ...
                                                        $diamond = $diamond[0];
                                                        @endphp
                                                        <p style="font-size: 16px; line-height: 18px;color: #000; margin: 0 0 4px;">Diamond : {{$diamond['quantity']}} {{$diamond['shape']}} Diamond, {{$diamond['carat']}} Carat, {{config('constant.'.$orderDetail['product_diamond_quality'])}}</p>
                                                        @endif
