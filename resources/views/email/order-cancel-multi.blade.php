                                ...
                                <table style="text-align: center; padding: 0 15px;">
                                    <tr>
                                        <td style="color: #000;font-size: 28px;line-height: 32px;font-weight: bold; padding: 20px 0;">
                                            We regret that you have canceled an item on order <a href="{{ url('/user/order-detail').'/'.$orderDetail['order_id'] }}" target="_blank">{{ $orderDetail['order_id'] }}</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: #000;font-size: 14px;line-height: 32px; padding: 0px;">
                                            Cancel Reason : {{ $orderDetail['order_detail'][0]['cancel_reason'] }}
                                        </td>
                                    </tr>
                                    <tr>
