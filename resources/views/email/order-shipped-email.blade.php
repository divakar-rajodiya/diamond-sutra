                    ...
                    <table style="border-spacing: 0;">
                                ...
                                <table style="text-align: center; padding: 0 15px;">
                                    <tr>
                                        <td style="color: #000;font-size: 28px;line-height: 32px;font-weight: bold; padding: 20px 0;">
                                            Exciting news! Your order {{$orderDetail['order_with_detail']['order_id']}} has been shipped.
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table style="width: 100%;border-spacing: 0;">
                                                <tr>
                                                    <td style="text-align: center;" colspan="4">
                                                        <img width="100%" src="{{ asset('public/assets/img/arrow-timeline-3.png')}}" alt="Diamond Sutra timeline">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td valign="top" style="width: 25%; text-align: center; padding: 0;margin: 0; font-size: 12px; padding: 10px 0 0;">
                                                        ...
                                                        <p style="margin: 0;font-size: 12px; line-height: 12px;">
                                                            {{explode('T',$orderDetail['order_with_detail']['created_at'])[0]}}
                                                        </p>
                                                    </td>
                                                    ...
                                                    <td valign="top" style="width: 25%; text-align: center; padding: 0;margin: 0; font-size: 12px; padding: 10px 0 0;">
                                                        ...
                                                        <p style="margin: 0;font-size: 12px; line-height: 12px;">{{ date('d-M-Y', strtotime($orderDetail['order_with_detail']['expected_delivery_date'])); }}</p>
                                                    </td>
                                                </tr>
                                                ...
                                                {{-- <tr style="text-align: center;">
                                                    <td style="text-align: center;" colspan="4">
                                                        <a href="{{$orderDetail['tracking_id']}}" style="text-decoration: none; font-size: 16px;color: #fff; padding: 12px 20px; border-radius: 30px; background-color: #000;">Track Your Order</a><br><br>
                                                    </td>
                                                </tr> --}}
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="color: #000;font-size: 16px;line-height: 22px;font-weight: normal;padding-bottom:10px;">
                                            You can track your package using the above <a target="_blank" href="{{$orderDetail['tracking_id']}}">link</a>. If you have any questions or need assistance, feel free to contact us.
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td style="text-align: left;padding-bottom:10px;">
                                <p style="margin: 0 0 20px;">Delivery times are estimated. If you
                                    are experiencing difficulty with this order please contact us at <a href="tel:+91 9799975281" style="font-weight: 600; color: #000; text-decoration: none;">+91 9799975281</a> See more info.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left;padding-bottom:10px;">
