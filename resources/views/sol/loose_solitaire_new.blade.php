                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="product-description">
                            <h3>View All Diamond<span class="total-available-product">[<span id="filtered_total">0</span> of <span id="total_records">0</span>]</span></h3>
                        ...
                        <div class="product-grid">
                            ...
                            <div class="row gy-3" id="diamond-filter-data">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover table-light" id="solitaire-table">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(function() {
            $("#price-slider-range").slider({
                ...
                slide: function(event, ui) {
                    ...
                    filters.price.min = ui.values[0]
                    filters.price.max = ui.values[1]
                    console.log(filters)
                    filterDiamondData()
                },
            });
            ...
            $("#carat-slider-range").slider({
                ...
                slide: function(event, ui) {
                    ...
                    filters.carat.min = ui.values[0]
                    filters.carat.max = ui.values[1]
                    console.log(filters)
                    filterDiamondData()
                },
            });
            ...
            $("#table-slider-range").slider({
                ...
                slide: function(event, ui) {
                    ...
                    filters.table.min = ui.values[0]
                    filters.table.max = ui.values[1]
                    console.log(filters)
                    filterDiamondData()
                },
            });
            ...
            $("#depth-slider-range").slider({
                ...
                slide: function(event, ui) {
                    ...
                    filters.depth.min = ui.values[0]
                    filters.depth.max = ui.values[1]
                    console.log(filters)
                    filterDiamondData()
                },
            });
        ...
        //         $('#total_records').text(res.data.length)
        ...
        //         console.log("Intial Filter :", filters);
        //         filterDiamondData()
        //     }
        // });
    ...
    //         success: function(res) {
    //             console.log(res);
    //             window.location.href = base_url + '/design-your-own-solitaire-' + category + '?cat=' + category + '&selected=1';
    //         },
    //     });
    // });
    ...
    //         success: function(res) {
    //             console.log(res);
    //             window.location.href = base_url + '/design-your-own-solitaire-' + category + '?cat=' + category;
    //         },
    //     });
    // });
    ...
    async function filterDiamondData() {
        ...
        filters.Cert = '';
        filters.Sym = '';
        filters.DisplayShape = '';
        filters.Weight = '';
        filters.Price = '';
        filters.Table = '';
        filters.TopDepth = '';
        filters.orderBy = 'ASC';
        filters.orderByField = 'price'
        filters.currentPage = currentPage;
        filters.itemPerPage = itemsPerPage;
        var filterUrl = `{{url('solitaire-pair-filter')}}`;
        let res = await filterData(filterUrl, "solitaire-table");
        if (res) {
            $('#diamond-loader').hide();
        }
    ...
    $(document).on('click', '.view-solitair-btn', function() {
        ...
        var base_url = $('#base_url').val();
        var token = $('#token').val();
        window.location.href = base_url + '/solitaire-details/' + refNo;
    ...
    $("#price-min,#price-max").on("change", function() {
        ...
        filters.price.min = min_price_range
        filters.price.max = max_price_range
        console.log(filters)
        filterDiamondData()
    });
    ...
    $("#carat-min,#carat-max").on("change", function() {
        ...
        filters.carat.min = min_price_range
        filters.carat.max = max_price_range
        console.log(filters)
        filterDiamondData()
    });
    ...
    $("#table-min,#table-max").on("change", function() {
        ...
        filters.table.min = min_price_range
        filters.table.max = max_price_range
        console.log(filters)
        filterDiamondData()
    });
    ...
    $("#depth-min,#depth-max").on("change", function() {
        ...
        filters.depth.min = min_price_range
        filters.depth.max = max_price_range
        console.log(filters)
        filterDiamondData()
    });
