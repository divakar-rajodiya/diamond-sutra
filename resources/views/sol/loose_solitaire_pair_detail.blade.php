                    ...
                    <div class="slider-content" id="slider-section-1">
                        <div class="xzoom-container h-100">
                            <a data-fancybox-trigger="gallery" href="javascript:;">
                                <img class="xzoom h-100 w-100 image-1" id="xzoom-default" src="{{$solitaire[0]['ImageLink']}}" xoriginal="{{$solitaire[0]['ImageLink']}}" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"/>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <div>
                    <div class="slider-content" id="slider-section-2">
                        <div class="xzoom-container h-100">
                            <a data-fancybox-trigger="gallery" href="javascript:;">
                                <img class="xzoom h-100 w-100 image-1" id="xzoom-default" src="{{$solitaire[1]['ImageLink']}}" xoriginal="{{$solitaire[1]['ImageLink']}}" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"/>
                            </a>
                        </div>
                    </div>
