      ...
      <div class="col-lg-6">
        ...
        <div>
          <div class="slider-content">
            <div class="xzoom-container h-100">
              <a data-fancybox-trigger="gallery" href="javascript:;">
                <img class="xzoom h-100 w-100 image-1" id="xzoom-default" src="{{$solitaire['ImageLink']}}" xoriginal="{{$solitaire['ImageLink']}}" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"/>
              </a>
            </div>
          </div>
          ...
          <div class="slider-thumb">
            <div class="slide"><img src="{{$solitaire['ImageLink']}}" alt="" class="img-fluid thumb-image thumb-image-1" onerror="this.onerror=null; this.src='http://dev.diamondsutra.in/public/assets/img/diamond.png';"></div>
