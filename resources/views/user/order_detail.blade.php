                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="product-thumbnail" style="text-align:center">
                                                    <img src="{{url('public/assets/img/product/').'/'.$orderDetail['product_sku'].'/'.$orderDetail['product_sku'].'_'.config('constant.COLOR_CODE.'.$orderDetail['product_color']).'1.webp'}}" class="img-fluid" alt="">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-thumbnail" style="text-align:center">
                                                    <img src="{{url('public/assets/img/product/').'/'.$chainDetail['product_sku'].'/'.$chainDetail['product_sku'].'_'.config('constant.COLOR_CODE.'.$chainDetail['selected_color']).'1.webp'}}" class="img-fluid" alt="">
                                                </td>
