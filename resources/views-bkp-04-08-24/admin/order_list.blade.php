    ...
    <tbody>
        ...
        <tr style="vertical-align: middle;">
            ...
            <td style="position:relative;">
                <select class="form-select bg-transparent order_status" name="order_status" id="order_status" data-id="{{$order['id']}}">
                    <option value='0' <?php if ($order['order_status'] == 0) {
                                            echo 'selected';
                                        }  ?>>Order Received</option>
                    <option value='1' <?php if ($order['order_status'] == 1) {
                                            echo 'selected';
                                        }  ?>>Getting It Ready</option>
                    ...
                    <option value='5' <?php if ($order['order_status'] == 5) {
                                            echo 'selected';
                                        } ?>>Initiate Return</option>
                    <option value='6' <?php if ($order['order_status'] == 6) {
                                            echo 'selected';
                                        } ?>>Returned</option>
                </select>
                <i class="fa-solid fa-spinner fa-spin status-loader"></i>
            </td>
