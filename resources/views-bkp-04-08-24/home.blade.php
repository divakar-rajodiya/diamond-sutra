        ...
        <div class="row align-items-center">
            <div class="col-md-6 col-lg-5">
                <div class="about-content wow fadeInLeft">
                    ...
                    <p class="mb-4">Welcome to Diamond Sutra, where tradition meets innovation in the vibrant city of
                        Jaipur. We understand the frustration of opaque pricing and high markups in traditional diamond
                        jewelry stores. That's why, guided by a legacy of three generations, we've embraced the digital
                        age to bring you an unparalleled diamond jewelry experience.</p>
            ...
            <div class="col-md-6">
                <div class="detail-box-div dbd-2">
                    ...
                    <div class="db-img wow fadeInDown">
                        <a href="{{url('/design-your-own-diamond-ring?cat=ring')}}"><img src="{{ url('public/assets/img/personalized_diamond.png') }}" alt="img" class="img-fluid"></a>
                    </div>
                </div>
            </div>
        </div>
