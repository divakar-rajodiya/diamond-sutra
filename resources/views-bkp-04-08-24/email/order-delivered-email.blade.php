                    ...
                    <table style="border-spacing: 0;">
                            ...
                            <td valign="top" class="side title" style="padding: 0;">
                                <table style="text-align: center; padding: 0 15px;">
                                    <tr>
                                        ...
                                        We're thrilled to inform you that your order {{ $orderDetail['order_id'] }} has been successfully delivered!
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td>
                                <table style="width: 100%;">
                                    <tr>
                                        <td style="padding: 10px 10px 10px 0px; width: 45%; vertical-align: top;">
                                        ...
                                        <td style="padding: 10px 0px 10px 0px; width: 55%; vertical-align: top;">
                                            <table style="width: 100%;">
