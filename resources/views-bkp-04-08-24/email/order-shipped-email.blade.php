                            ...
                            <td valign="top" class="side title" style="padding: 0;">
                                <table style="text-align: center; padding: 0 15px;">
                                    ...
                                    <tr>
                                        <td style="text-align: left; border-collapse: collapse;border: 0;margin: 0;padding: 0;padding-top:5px;-webkit-text-size-adjust: none;color: #000;font-size: 16px;line-height: 24px;font-weight: normal;">
                                            <table style="width: 100%;border-spacing: 0;">
                                                ...
                                                <tr style="text-align: center;">
                                                    <td style="text-align: center;" colspan="4">
                                                        <a href="{{$orderDetail['order_tracking']}}" style="text-decoration: none; font-size: 16px;color: #fff; padding: 12px 20px; border-radius: 30px; background-color: #000;">Track Your Order</a><br><br>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        You can track your package using the above <a target="_blank" href="{{$orderDetail['order_tracking']}}">link</a>. If you have any questions or need assistance, feel free to contact us.
                                        </td>
                                    </tr>
                                    <tr>
