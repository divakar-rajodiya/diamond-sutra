...
<head>
    ...
    <title>Diamond Sutra Order Return</title>
</head>
                            ...
                            <td valign="top" class="side title" style="padding: 0;">
                                <table style="text-align: center; padding: 0 15px;">
                                    <tr>
                                        ...
                                        We regret that you have initiated return for the order <a href="{{ url('/order-detail').'/'.$orderDetail['order_id'] }}" target="_blank">{{$orderDetail['order_id']}}</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: #000;font-size: 16px;line-height: 18px;">
                                            Return Reason : <br>
                                            {{ $orderDetail['return_reason'] }}
                                        </td>
                                    </tr>
                                    <tr style="text-align: center;">
                                        <td style="text-align: center; border-collapse: collapse;border: 0;margin: 0;padding: 0;padding-top:5px;-webkit-text-size-adjust: none;color: #000;font-size: 16px;line-height: 24px;font-weight: normal;">
                                            <table style="width: 100%;border-spacing: 0;text-align:center;">
                                                <tr style="text-align: center;">
                                                    <td style="text-align: center; padding: 40px 0;" colspan="4">
                                                        <a href="{{ url('/order-detail').'/'.$orderDetail['order_id'] }}" style="text-decoration: none; font-size: 16px;color: #fff; padding: 12px 20px; border-radius: 30px; background-color: #000;display:inline-block;">View your order</a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        Our team will get in touch with you to schedule the pickup.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom:10px;">
                                        Once we have received the product, your refund will be processed to your account in 7-8 working days after a quality check.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom:10px;">
                                        If there's anything specific that led to this decision, or if there's anything we can do to improve your experience with us in the future, please do not hesitate to share your feedback. 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding-bottom:10px;">
                                            ...
                                            <table style="width: 100%;">
                                               ...
                                               @if($orderDetail['coupon_code'] != null)
                                                <tr style="font-size:15px;">
                                                   ...
                                                   <td style="font-weight: bold;text-align:right;">- {{\General::currency_format($orderDetail['discount_amount'])}}</td>
                                                </tr>
                                                @endif
                                               <tr style="font-size:15px;">
                                                   <td>GST</td>
